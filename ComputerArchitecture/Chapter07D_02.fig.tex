...
\draw[red,thick,-latex] (0-M-i.south) to[out=-90,in=130] node[pos=0.6,right,font=\footnotesize] {(MEM)} node[pos=0.9,right] {Forwarding} (1-E-i1.north);

\draw[red,thick,-latex] (0-W-i.south) to[out=-90,in=120] node[pos=0.84,right,font=\footnotesize] {(WB)} node[pos=0.95,right] {Forwarding} (2-E-i1.north);
