...
\draw[line data] (MUXPCNext.brpin 1) -- node[above,signal] {PCNext} (REGPC.west);

% REGPC ->[PC] IMEM.A
\draw[line data] (REGPC.east) -- node[above,signal] {PC} (IMEM-A);

% IMEM -[Instr] |
\draw[line data] (IMEM-RD) -- node[above,signal] {Instr} (xInstr|-IMEM-RD);
...
\draw[line data] (REGFILE-RD1) -|
 (xMUXSrcBin1|-ALU.blpin 1) -- (ALU.blpin 1) node[above left,signal] {SrcA};
...
\draw[line data] (IMMExtend.east) node[above right,signal] {ImmExt} -- (ADDPCTarget.blpin 2);
...
% 4 -> ADDPCPlus4.in2
\draw[line data] (xPC|-ADDPCPlus4.blpin 2) node[ocirc] {} node[left,signal] {4} -- (ADDPCPlus4.blpin 2);

% ADDPCPlus4.out -> MUXPCNext.in1
\draw[line data] (ADDPCPlus4.brpin 2) node[above right,signal] {PCPlus4} -- (xPCPlus4|-ADDPCPlus4.brpin 2) |- (xMUXPCNextin1|-yPCPlus4) |- (MUXPCNext.blpin 1);

% ALU.out ->[ALUResult] DMEM.A
\draw[line data] (ALU.brpin 2) node[above right,signal] {ALUResult} -- (DMEM-A);
