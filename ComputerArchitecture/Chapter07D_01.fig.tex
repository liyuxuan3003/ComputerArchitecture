...
% MUX Rs1Data
\path (DE.east|-REGFILE-RD1) ++(5.5,0) node[mux31,anchor=blpin 1] (MUXRs1Data) {};
...
% x
\path (DE.east) ++(0.5,0) coordinate (xRdE) ++(0.5,0) coordinate (xRs2E) ++(0.5,0) coordinate (xRs1E) ++(0.5,0) coordinate (xPCE) coordinate (xImmExtE) ++(0.5,0) coordinate (xPCSrcE) ++(1.0,0) coordinate (xResultSrcE);
...
\draw[line data] (FD.east|-yPC) -- (DE.west|-yPC) node[above left,signal] {PCD};
...
\foreach \y in {CU-funct3,CU-funct7,REGFILE-A1,REGFILE-A2,yRs1,yRs2,yRd}
{
...
\draw[line control] (xORout|-ORPCSrc.out) node[circ] {} |- (xPCSrcE|-CU-ImmSrc) -- (xPCSrcE|-Hazard.north) node[above left,signal] {\rotatebox{90}{PCSrcE}};
\draw[line control] (xResultSrcE|-CU-ResultSrc) node[circ] {} -- (xResultSrcE|-Hazard.north) node[above left,signal] {\rotatebox{90}{ResultSrcE}};
