...
\foreach \yt/\t in{%
    0/{Field of Instruction Type: \texttt{opcode,funct3,funct7}},%
    1/{Field of Operand: \texttt{imm,rs1,rd}},%
    2/{Immediate Bits (Encode/Actual): 05/05},
    3/{Immediate Type: Unsigned},
    4/{Instruction: \texttt{slli,srli,srai}}
}%
{
