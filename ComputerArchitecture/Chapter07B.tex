...
\begin{Figure}[单周期RISC-V处理器]
    \includegraphics[width=\linewidth]{Chapter07B_01.fig.pdf}
\end{Figure}
...
\begin{Table}[Main Decoder真值表]!!
    \begin{tblr}
    {
        ...
        I/LOAD & 0000011 & 1 & 00 & 1 & 0 & 01 & 0 & 0 & 00\\
        S/STORE & 0100011 & 0 & 01 & 1 & 1 & xx & 0 & 0 & 00\\
        R/OP & 0110011 & 1 & xx & 0 & 0 & 00 & 0 & 0 & 10\\
        I/OP-IMM & 0010011 & 1 & 00 & 1 & 0 & 00 & 0 & 0 & 10\\
