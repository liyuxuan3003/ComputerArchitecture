...
\begin{Table}[I型指令的列表]!!
    \begin{tblr}
    {
        ...
        xori rd,rs1,imm&rd=rs1\^{}SE(imm)&I1&0010011&100&-------\\*
        Xor Immediate&&立即数异或&&&\\
        ori rd,rs1,imm&rd=rs1|SE(imm)&I1&0010011&110&-------\\*
        Or Immediate&&立即数或&&&\\
        andi rd,rs1,imm&rd=rs1\&SE(imm)&I1&0010011&111&-------\\*
        And Immediate&&立即数与&&&\\
        slti rd,rs1,imm&rd=(rs1<SE(imm))&I1&0010011&010&-------\\*
        Set Less Than Immediate&&立即数当小于（有符号）时赋值&&&\\
        sltiu rd,rs1,imm&rd=(rs1<SE(imm))&I1&0010011&011&-------\\*
