...
% Instr Split
\foreach \y/\bmax/\bmin/\type/\val in {CU-op/06/00/emph data/,CU-funct3/14/12/emph data/,CU-funct7/31/25/emph data/,REGFILE-A1/19/15/line data/,REGFILE-A2/24/20/line data/,REGFILE-A3/11/07/line data/,IMMExtend.west/31/07/emph data/ximm}
{
...
% ALU.out -> REGALUOut
\draw[emph data no arrow] (ALU.brpin 2) node[above right,signal] {ALUResult} -- node[below,value,align=center] {rs1+imm\\ (rd)} (xALUResult|-ALU.brpin 2); 
...
\path (LogoCenter) node[draw,minimum width=6cm,minimum height=2.2cm,ultra thick,black,fill=black!50!white,align=center,text=white,font=\LARGE\bfseries\rmfamily] (Logo) {S4\;:\;ExecuteI\\ {}};

\path (LogoCenter) node[align=center,yshift=-0.4cm,text=white,font=\rmfamily\footnotesize] {I/OP-IMM$\to$S7};
...
\path (ControlInfo) node[draw,minimum width=3.0cm,minimum height=5cm,ultra thick,black,fill=black!50!white,align=center,text=white,font=\ttfamily] {ALUSrcA=10\\ ALUSrcB=01\\ ALUOp=10};
