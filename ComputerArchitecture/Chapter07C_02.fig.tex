...
\path (LogoCenter) node[draw,minimum width=6cm,minimum height=2.2cm,ultra thick,black,fill=black!50!white,align=center,text=white,font=\LARGE\bfseries\rmfamily] {S0\;:\;Fetch\\ {}};

\path (LogoCenter) node[align=center,yshift=-0.4cm,text=white,font=\rmfamily] {$\to$ S1}; 
...
\path (ControlInfo) node[draw,minimum width=3.0cm,minimum height=5cm,ultra thick,black,fill=black!50!white,align=center,text=white,font=\ttfamily] {AdrSrc=0\\ IRWrite\\ ALUSrcA=00\\ ALUSrcB=10\\ ALUOp=00\\ ResultSrc=10\\ PCUpate};
